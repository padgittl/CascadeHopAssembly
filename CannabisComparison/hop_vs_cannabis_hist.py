...
def countGenes(coordDict,uniprotDict,topHit):
    ...
    for uniprotGeneID in uniprotGeneCount:
        ...
        print uniprotGeneID,uniprotGeneCount[uniprotGeneID]
...
def createHist(hopUniprotGeneCount,hopCountList,canUniprotGeneCount,canCountList):
    ...
    plt.legend(handles=[legendHop,legendCan], framealpha=None, edgecolor='inherit', frameon=False,loc='upper right', fontsize = '16')
    plt.savefig('blastHitCopyNumberHist_v2.pdf')
    plt.savefig('blastHitCopyNumberHist_v2.svg')
